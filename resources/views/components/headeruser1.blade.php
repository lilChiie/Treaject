...
<section class="fixed font-serif top-0 left-0 w-full bg-white z-50">
<!-- header start -->
<header class=" ">
  <nav class=" px-4  lg:px-6 py-2 dark:bg-black ">
      <div class="flex justify-between">
          <div class="flex justify-start items-center ps-5">
              <a href="/" class="flex mr-4">
                <img src="{{ url('images/logo.jpg') }}" class="mr-3 h-10 rounded-full" alt="FlowBite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Treaject</span>
              </a>
            </div>
          ...
          <div class="flex items-center pe-5">
            ...
            <div class="flex w-full ">
                <form action="#" method="" class="block lg:pl-2">
                    <label for="topbar-search" class="sr-only">Search</label>
                    <div class="relative mt-1 w-44 md:w-96">
            ...
            <!--profil  -->
              <button type="button" class="flex text-sm mx-3 bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                  <span class="sr-only">Open user menu</span>
                  <img class=" aspect-square object-cover w-12 h-10 rounded-full" src="{{ url('images/profil.jpg') }}" alt="user photo">
              </button>
              <!-- Dropdown menu -->
...
<!-- navbar start -->
<nav class="">
    <div class="py-2 dark:bg-black">
        
            
        <div class="flex justify-center items-center mt-1">
            <div class=" mx-5 font-bold hover:text-merah duration-700">
                <a href="/" class="text-xl dark:text-white dark:hover:text-merah duration-700
                 {{ request()->is('/', 'user/GenreNovelUser') ? 'text-merah dark:text-merah' : 'text-black dark:text-black' }}">For You</a>
            </div>
            <div class=" mx-5 font-bold hover:text-merah duration-700">
                <a href="/user/GenreKomikUser" class="text-xl dark:text-white dark:hover:text-merah duration-700
                {{ request()->is('user/GenreKomikUser', 'user/GenreNovelUser') ? 'text-merah dark:text-merah' : 'text-black dark:text-black' }}">Genre</a>
            </div>
            <div class=" mx-5 font-bold hover:text-merah duration-700">
                <a href="#" class="text-xl dark:text-white dark:hover:text-merah duration-700">Schedule</a>
            </div>
            <div class=" mx-5 font-bold hover:text-merah duration-700">
                <a href="#" class="text-xl dark:text-white dark:hover:text-merah duration-700">My Creation</a>
            </div>
        </div>
    </div>
</nav>
