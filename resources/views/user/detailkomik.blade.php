...
<head>
    ...
    <title>Treaject | Detail Komik</title>
</head>
<body class="dark">
    <main class="font-serif dark:bg-black px-10 md:px-24 pt-3 pb-20">
        <a href="/" class="">
            <svg  class="w-5 mb-8 pt-3 dark:fill-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 448 512">
        ...
        <section>
            <div>
                <div class="relative ...">
                <img class="w-full rounded-lg h-72 object-cover blur-sm" src="{{ url('images/slider.jpg') }}" alt="">
                    <div class="absolute w-full top-12 left-0 ...">
                        <div class=" w-full flex justify-center">
                            <img src="{{ url('images/nia.png') }}" class=" rounded-full aspect-square w-2/6 object-cover" alt="">
                        </div>
                    </div>
                </div>
            </div>

            <div class="flex justify-center mt-40 dark:text-white">
                <div class="">
                    <p class="font-bold text-4xl mb-3">The economic of villans</p>
                    <div class="flex gap-x-2 mb-10">
                        <div>
                            <svg class="w-7 dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <p class="font-bold">Author: <span class="font-medium text-gray-800 dark:text-gray-100">Anonim</span></p>
                </div>
          </div>
        </section>
        <!-- head komik end -->
        ...
        <section>
            ...
            <!-- favorite -->
            <div class="mt-6">
                <button type="button" class="text-white bg-[#050708] hover:bg-merah focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg transition duration-700 text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-2 dark:hover:bg-merah">
