...
<main class=" font-serif dark:bg-black ps-2 pr-2 sm:ps-[288px] sm:pt-12 sm:pr-8">
    <a href="/admin/DaftarNovel">
        ...
        <section>
            <div class="grid grid-cols-3 gap-x-7">
                ...
                <div class=" col-span-2">
                    ...
                    <p class="font-bold mb-4">Author: <span class="font-medium text-gray-800">Anonim</span></p>
        ...
        <section>
            <div class="my-3">
                <p class=" font-bold text-[28px]">Sinopsis</p>
        ...
        <section>
            ...
            <div>
                <!-- 1 -->
                <a href="/admin/ChapterNovel" class="mb-2 hover:brightness-50  ">
                    <div class="flex border-2 border-50 mb-2 border-b-gray-500  rounded-lg px-1 py-2">
                        <div class="mx-4 w-10/12 flex items-center text-center">
                            <div>
                                <p class=" font-medium text-[20px]">Ep 1 <span class="mx-2">Prolog</span></p>
                            </div>
                        </div>
                ...
                <a href="/admin/ChapterNovel" class="mb-2 hover:brightness-50  ">
                    <div class="flex border-2 border-50 mb-2 border-b-gray-500  rounded-lg px-1 py-2">
                        <div class="mx-4 w-10/12 flex items-center text-center">
                            <div>
                                <p class=" font-medium text-[20px]">Ep 2 <span class="mx-2">Curhatan</span></p>
                            </div>
                        </div>
                        <div class="flex justify-end  items-center text-center">
                            <div>
                ...
                <a href="/admin/ChapterNovel" class="mb-2 hover:brightness-50  ">
                    <div class="flex border-2 border-50 mb-2 border-b-gray-500  rounded-lg px-1 py-2">
                        <div class="mx-4 w-10/12 flex items-center text-center">
                            <div>
                                <p class=" font-medium text-[20px]">Ep 3 <span class="mx-2">Andromeda</span></p>
                            </div>
                        </div>
                        <div class="flex justify-end  items-center text-center">
                            <div>
                ...
                <a href="/admin/ChapterNovel" class="mb-2 hover:brightness-50  ">
                    <div class="flex border-2 border-50 mb-2 border-b-gray-500  rounded-lg px-1 py-2">
                        <div class="mx-4 w-10/12 flex items-center text-center">
                            <div>
                                <p class=" font-medium text-[20px]">Ep 4 <span class="mx-2">Bima Sakti</span></p>
                            </div>
                        </div>
                        <div class="flex justify-end  items-center text-center">
                            <div>
